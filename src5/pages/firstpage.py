...
class FirstPage(PageFactory):
    ...
    locators = {
        ...
        "acasa": ("XPATH",
                  '/html/body/tz-dialog/div[1]/div/div[2]/div/tz-address-dialog/div/tz-address-dialog-map/div/div[2]/div[2]/div/div[4]/div[2]'),
        "save": ("XPATH",
    ...
    def locatie_text(self):
        self.locatie.send_keys("strada Sararie 4")
    ...
    def detalii_text(self):
        self.detalii.send_keys("cladirea de birouri, sunati la interfon")
